...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.accompaniment_menu_fragment_to_checkout_fragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.accompaniment_menu_fragment_back_to_start_order_fragment)
    }
