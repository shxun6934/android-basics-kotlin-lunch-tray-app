...
class EntreeMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.entree_menu_fragment_to_side_menu_fragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.entree_menu_fragment_back_to_start_order_fragment)
    }
