...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.side_menu_fragment_to_accompaniment_menu_fragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.side_menu_fragment_back_to_start_order_fragment)
    }
