...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        if (_subtotal.value != 0.0) _subtotal.value = _subtotal.value!! - previousEntreePrice
        ...
        val currentEntree = menuItems[entree]
        _entree.value = currentEntree
        updateSubtotal(currentEntree?.price ?: 0.0)
    }
    ...
    fun setSide(side: String) {
        ...
        if (_subtotal.value != 0.0) _subtotal.value = _subtotal.value!! - previousSidePrice
        ...
        val currentSide = menuItems[side]
        _side.value = currentSide
        updateSubtotal(currentSide?.price ?: 0.0)
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        //  accompaniment.
        if (_subtotal.value != 0.0) _subtotal.value =
        ...
        val currentAccompaniment = menuItems[accompaniment]
        _accompaniment.value = currentAccompaniment
        updateSubtotal(currentAccompaniment?.price ?: 0.0)
    }
